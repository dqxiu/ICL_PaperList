...
4. evaluate the reasoning abilities of large language models in multilingual settings, introduce the Multilingual Grade School Math (MGSM) benchmark, by manually translating 250 grade-school math problems from the GSM8K dataset into ten typologically diverse languages.
5. **Instruction Induction: From Few Examples to Natural Language Task Descriptions how to learn task instructions from input output demonstrations
6. **Language Models Are Greedy Reasoners: A Systematic Formal Analysis of Chain-of-Thought2022.10.3  ![](https://img.shields.io/badge/New-EAD8D9)
