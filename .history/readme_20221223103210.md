...
3. **Calibrate Before Use: Improving Few-shot Performance of Language Models  Using N/A string to calibrate LMs away from common token bias**. ![](https://img.shields.io/badge/Abbre-DCE7F1)
   *authors*.  [[pdf](link)], [[project](link)], 202X.XX, ![](<https://img.shields.io/badge/ICML> 2021-FAEFCA)
