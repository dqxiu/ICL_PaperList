...
3. **Calibrate Before Use: Improving Few-shot Performance of Language Models**. ![](https://img.shields.io/badge/Abbre-DCE7F1)
   *authors*.  [[pdf](http://proceedings.mlr.press/v139/zhao21c.html)], [[project](link)], 202X.XX, ![](<<https://img.shields.io/badge/ICML2021-FAEFCA>)
    ![](https://img.shields.io/badge/Warm-EAD8D9) ![](<<https://img.shields.io/badge/feature-D8D0E1>)
